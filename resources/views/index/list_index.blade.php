...
@section('datas')
	...
	<div class="section product">
		<div class="container">
			...
			<div class="row">
				@foreach($info as $v)
				<input  type="hidden" name="zhou_id" value="{{$v->zhou_id}}">
				<div class="col s6">
					<div class="content">
						...
						<button class="btn button-default"><a href="{{url('/details_index?zhou_id=')}}{{$v->zhou_id}}" style="color:black;">商品详情</a></button>
					</div>
				</div>
				@endforeach
			</div>
